...
let UsersController = class UsersController {
    ...
    async getUsers(page, limit) {
        const users = await this.usersService.getUsers(Number(page) || 1, Number(limit) || 5);
        return (0, class_transformer_1.plainToInstance)(users_entity_1.User, users, { excludeExtraneousValues: true });
    }
...
__decorate([
    ...
    openapi.ApiResponse({ status: common_1.HttpStatus.OK, type: [require("./entities/users.entity").User] }),
