...
let OrderDetail = class OrderDetail {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String, default: (0, uuid_1.v4)() }, price: { required: true, type: () => Number }, order: { required: true, type: () => require("../../orders/entities/orders.entity").Order }, products: { required: true, type: () => [require("../../products/entities/products.entity").Product] } };
    }
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => orders_entity_1.Order, (order) => order.details),
